...
public enum tipoVehiculo {
    ...
    public tipoVehiculo get(int ordinal) throws OperationNotSupportedException {
        if (esOrdinalValido(ordinal)) {
            ...
            throw new OperationNotSupportedException("No se encuentra el ordinal insertado");
        }
    }
    ...
    public tipoVehiculo get(Vehiculo vehiculo) throws OperationNotSupportedException {
        if (vehiculo instanceof Turismo) {
            ...
            throw new OperationNotSupportedException("No se encuentra el tipo de vehiculo insertado en nuestros tipos");
        }
    }
